...
class SpeechToCoefficientsModel(nn.Module):
    def __init__(self, audio_dim: int = 80, output_dim: int = 182, hidden_dim: int = 256, num_layers: int = 4, num_heads: int = 8):
        super().__init__()
    ...
    def forward(self, audio_features: torch.Tensor, src_key_padding_mask: torch.Tensor = None) -> torch.Tensor:
        """
